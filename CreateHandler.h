...
// This class represents a operation of creating SURL from RawURL and storing them to a database.
// Example:
...
public:
	...
	void CreateSURL();
	// Returns the SURL that created in database. If it isn't created, returns empty string.
	std::string GetSURL();
